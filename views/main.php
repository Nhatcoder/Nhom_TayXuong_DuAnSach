                            ...
                            <div class="px-4 py-5 px-md-6 border-bottom">
                                <div class="media">
                                    ...
                                    <div class="media-body ml-4d875">
                                        ...
                                        <div class="font-size-2 mb-1 text-truncate"><a href="#"
                                                class="text-gray-700">Gordon Corera</a>
                                        </div>
                                        <div class="price d-flex align-items-center font-weight-medium font-size-3">
    ...
    <section class="space-bottom-3">
        <div class="bg-gray-200 space-2 space-lg-0 bg-img-hero"
            style="background-image: url(./views/assets/img/1920x588/img1.jpg);">
            <div class="container">
    ...
    <section class="space-bottom-3">
        <div class="container">
            <header class="mb-5 d-md-flex justify-content-between align-items-center">
                ...
                <a href="https://demo2.madrasthemes.com/bookworm-html/redesigned-octo-fiesta/html-demo/shop/v1.html"
                    class="h-primary d-block">All Categories <i class="glyph-icon flaticon-next"></i></a>
            </header>
            <ul class="list-unstyled my-0 row row-cols-md-2 row-cols-lg-3 row-cols-xl-4 row-cols-wd-5">
                ...
                <li class="product-category col mb-4 mb-xl-0">
                    <div class="product-category__inner bg-tangerine-light px-6 py-5">
                        <div class="product-category__icon font-size-12 text-tangerine"><i
                                class="glyph-icon flaticon-cook"></i>
                        </div>
                        <div class="product-category__body">
                ...
                <li class="product-category col mb-4 mb-xl-0">
                    <div class="product-category__inner bg-chili-light px-6 py-5">
                        <div class="product-category__icon font-size-12 text-chili"><i
                                class="glyph-icon flaticon-like"></i></div>
                        <div class="product-category__body">
                ...
                <li class="product-category col mb-4 mb-xl-0">
                    <div class="product-category__inner bg-carolina-light px-6 py-5">
                        <div class="product-category__icon font-size-12 text-carolina"><i
                                class="glyph-icon flaticon-doctor"></i>
                        </div>
                        <div class="product-category__body">
    ...
    <section class="space-bottom-3">
        <div class="container">
            <header class="mb-5 d-md-flex justify-content-between align-items-center">
                ...
                <a href="https://demo2.madrasthemes.com/bookworm-html/redesigned-octo-fiesta/html-demo/shop/v1.html"
                    class="h-primary d-block">View All <i class="glyph-icon flaticon-next"></i></a>
            </header>
                        ...
                        <div
                            ...
                            <div class="woocommerce-loop-product__thumbnail">
                                <a href="https://demo2.madrasthemes.com/bookworm-html/redesigned-octo-fiesta/html-demo/shop/single-product-v1.html"
                                    class="d-block"><img src="./views/assets/img/150x226/img1.jpg"
                            ...
                            <div class="woocommerce-loop-product__body product__body pt-3 bg-white">
                                ...
                                <h2
                                    ...
                                    <a
                                        href="https://demo2.madrasthemes.com/bookworm-html/redesigned-octo-fiesta/html-demo/shop/single-product-v1.html">Think
                        ...
                        <li class="product col">
                            <div class="product__inner overflow-hidden p-3 p-md-4d875">
                                <div
                                    ...
                                    <div class="woocommerce-loop-product__thumbnail">
                                        <a href="https://demo2.madrasthemes.com/bookworm-html/redesigned-octo-fiesta/html-demo/shop/single-product-v1.html"
                                            class="d-block"><img src="./views/assets/img/120x180/img1.jpg"
                                                class="img-fluid d-block mx-auto attachment-shop_catalog size-shop_catalog wp-post-image img-fluid"
                                                alt="image-description"></a>
                                    </div>
                                    <div class="woocommerce-loop-product__body product__body pt-3 bg-white">
                                        ...
                                        <div class="font-size-2  mb-1 text-truncate"><a
                                                href="others/authors-single.html" class="text-gray-700">Jay Shetty</a>
                                        </div>
                                        <div class="price d-flex align-items-center font-weight-medium font-size-3">
                                            <span class="woocommerce-Price-amount amount"><span
                                                    class="woocommerce-Price-currencySymbol">$</span>29</span>
                        ...
                        <li class="product col">
                            <div class="product__inner overflow-hidden p-3 p-md-4d875">
                                <div
                                    ...
                                    <div class="woocommerce-loop-product__thumbnail">
                                        <a href="https://demo2.madrasthemes.com/bookworm-html/redesigned-octo-fiesta/html-demo/shop/single-product-v1.html"
                                            class="d-block"><img src="./views/assets/img/120x180/img2.jpg"
                                                class="img-fluid d-block mx-auto attachment-shop_catalog size-shop_catalog wp-post-image img-fluid"
                                                alt="image-description"></a>
                                    </div>
                                    <div class="woocommerce-loop-product__body product__body pt-3 bg-white">
                        ...
                        <li class="product col">
                            <div class="product__inner overflow-hidden p-3 p-md-4d875">
                                <div
                                    ...
                                    <div class="woocommerce-loop-product__thumbnail">
                                        <a href="https://demo2.madrasthemes.com/bookworm-html/redesigned-octo-fiesta/html-demo/shop/single-product-v1.html"
                                            class="d-block"><img src="./views/assets/img/120x180/img3.jpg"
                                                class="img-fluid d-block mx-auto attachment-shop_catalog size-shop_catalog wp-post-image img-fluid"
                                                alt="image-description"></a>
                                    </div>
                                    <div class="woocommerce-loop-product__body product__body pt-3 bg-white">
                        ...
                        <li class="product col">
                            <div class="product__inner overflow-hidden p-3 p-md-4d875">
                                <div
                                    ...
                                    <div class="woocommerce-loop-product__thumbnail">
                                        <a href="https://demo2.madrasthemes.com/bookworm-html/redesigned-octo-fiesta/html-demo/shop/single-product-v1.html"
                                            class="d-block"><img src="./views/assets/img/120x180/img4.jpg"
                                                class="img-fluid d-block mx-auto attachment-shop_catalog size-shop_catalog wp-post-image img-fluid"
                                                alt="image-description"></a>
                                    </div>
                                    <div class="woocommerce-loop-product__body product__body pt-3 bg-white">
                                        ...
                                        <h2
                                            class="woocommerce-loop-product__title product__title h6 text-lh-md mb-1 text-height-2 crop-text-2 h-dark">
                                            <a
                                                href="https://demo2.madrasthemes.com/bookworm-html/redesigned-octo-fiesta/html-demo/shop/single-product-v1.html">Broken
                        ...
                        <li class="product col">
                            <div class="product__inner overflow-hidden p-3 p-md-4d875">
                                <div
                                    ...
                                    <div class="woocommerce-loop-product__thumbnail">
                                        <a href="https://demo2.madrasthemes.com/bookworm-html/redesigned-octo-fiesta/html-demo/shop/single-product-v1.html"
                                            class="d-block"><img src="./views/assets/img/120x180/img5.jpg"
                                                class="img-fluid d-block mx-auto attachment-shop_catalog size-shop_catalog wp-post-image img-fluid"
                                                alt="image-description"></a>
                                    </div>
                                    <div class="woocommerce-loop-product__body product__body pt-3 bg-white">
                        ...
                        <li class="product col">
                            <div class="product__inner overflow-hidden p-3 p-md-4d875">
                                <div
                                    ...
                                    <div class="woocommerce-loop-product__thumbnail">
                                        <a href="https://demo2.madrasthemes.com/bookworm-html/redesigned-octo-fiesta/html-demo/shop/single-product-v1.html"
                                            class="d-block"><img src="./views/assets/img/120x180/img6.jpg"
                                                class="img-fluid d-block mx-auto attachment-shop_catalog size-shop_catalog wp-post-image img-fluid"
                                                alt="image-description"></a>
                                    </div>
                                    <div class="woocommerce-loop-product__body product__body pt-3 bg-white">
                        ...
                        <li class="product col">
                            <div class="product__inner overflow-hidden p-3 p-md-4d875">
                                <div
                                    ...
                                    <div class="woocommerce-loop-product__thumbnail">
                                        <a href="https://demo2.madrasthemes.com/bookworm-html/redesigned-octo-fiesta/html-demo/shop/single-product-v1.html"
                                            class="d-block"><img src="./views/assets/img/120x180/img7.jpg"
                                                class="img-fluid d-block mx-auto attachment-shop_catalog size-shop_catalog wp-post-image img-fluid"
                                                alt="image-description"></a>
                                    </div>
                                    <div class="woocommerce-loop-product__body product__body pt-3 bg-white">
                        ...
                        <li class="product col">
                            <div class="product__inner overflow-hidden p-3 p-md-4d875">
                                <div
                                    ...
                                    <div class="woocommerce-loop-product__thumbnail">
                                        <a href="https://demo2.madrasthemes.com/bookworm-html/redesigned-octo-fiesta/html-demo/shop/single-product-v1.html"
                                            class="d-block"><img src="./views/assets/img/120x180/img8.jpg"
                                                class="img-fluid d-block mx-auto attachment-shop_catalog size-shop_catalog wp-post-image img-fluid"
                                                alt="image-description"></a>
                                    </div>
                                    <div class="woocommerce-loop-product__body product__body pt-3 bg-white">
                        ...
                        <li class="product col d-xl-none d-wd-block">
                            <div class="product__inner overflow-hidden p-3 p-md-4d875">
                                <div
                                    ...
                                    <div class="woocommerce-loop-product__thumbnail">
                                        <a href="https://demo2.madrasthemes.com/bookworm-html/redesigned-octo-fiesta/html-demo/shop/single-product-v1.html"
                                            class="d-block"><img src="./views/assets/img/120x180/img9.jpg"
                                                class="img-fluid d-block mx-auto attachment-shop_catalog size-shop_catalog wp-post-image img-fluid"
                                                alt="image-description"></a>
                                    </div>
                                    <div class="woocommerce-loop-product__body product__body pt-3 bg-white">
                        ...
                        <li class="product col d-xl-none d-wd-block">
                            <div class="product__inner overflow-hidden p-3 p-md-4d875">
                                <div
                                    ...
                                    <div class="woocommerce-loop-product__thumbnail">
                                        <a href="https://demo2.madrasthemes.com/bookworm-html/redesigned-octo-fiesta/html-demo/shop/single-product-v1.html"
                                            class="d-block"><img src="./views/assets/img/120x180/img10.jpg"
                                                class="img-fluid d-block mx-auto attachment-shop_catalog size-shop_catalog wp-post-image img-fluid"
                                                alt="image-description"></a>
                                    </div>
                                    <div class="woocommerce-loop-product__body product__body pt-3 bg-white">
                ...
                <div class="js-slick-carousel u-slick products border bg-white no-gutters"
                    ...
                    <div class="product product__card border-right">
                        <div class="media p-md-6 p-4 d-block d-md-flex">
                            <div class="woocommerce-loop-product__thumbnail mb-4 mb-md-0">
                                <a href="https://demo2.madrasthemes.com/bookworm-html/redesigned-octo-fiesta/html-demo/shop/single-product-v1.html"
                                    class="d-block"><img src="./views/assets/img/200x327/img1.jpg"
                            ...
                            <div class="woocommerce-loop-product__body media-body ml-md-5d25">
                                <div class="mb-3">
                                    ...
                                    <h2
                                        ...
                                        <a
                                            href="https://demo2.madrasthemes.com/bookworm-html/redesigned-octo-fiesta/html-demo/shop/single-product-v1.html">Dark
                    ...
                    <div class="product product__card border-right">
                        <div class="media p-md-6 p-4 d-block d-md-flex">
                            <div class="woocommerce-loop-product__thumbnail mb-4 mb-md-0">
                                <a href="https://demo2.madrasthemes.com/bookworm-html/redesigned-octo-fiesta/html-demo/shop/single-product-v1.html"
                                    class="d-block"><img src="./views/assets/img/200x327/img2.jpg"
                                        class="attachment-shop_catalog size-shop_catalog wp-post-image d-block mx-auto"
                                        alt="image-description"></a>
                            </div>
                            <div class="woocommerce-loop-product__body media-body ml-md-5d25">
                                <div class="mb-3">
                                    ...
                                    <h2
                                        class="woocommerce-loop-product__title font-size-3 text-lh-md mb-2 text-height-2 crop-text-2 h-dark">
                                        <a
                                            href="https://demo2.madrasthemes.com/bookworm-html/redesigned-octo-fiesta/html-demo/shop/single-product-v1.html">Under
                    ...
                    <div class="product product__card border-right">
                        <div class="media p-md-6 p-4 d-block d-md-flex">
                            <div class="woocommerce-loop-product__thumbnail mb-4 mb-md-0">
                                <a href="https://demo2.madrasthemes.com/bookworm-html/redesigned-octo-fiesta/html-demo/shop/single-product-v1.html"
                                    class="d-block"><img src="./views/assets/img/200x327/img3.jpg"
                                        class="attachment-shop_catalog size-shop_catalog wp-post-image d-block mx-auto"
                                        alt="image-description"></a>
                            </div>
                            <div class="woocommerce-loop-product__body media-body ml-md-5d25">
                        ...
                        <div class="media p-md-6 p-4 d-block d-md-flex">
                            <div class="woocommerce-loop-product__thumbnail mb-4 mb-md-0">
                                <a href="https://demo2.madrasthemes.com/bookworm-html/redesigned-octo-fiesta/html-demo/shop/single-product-v4.html"
                                    class="d-block"><img src="./views/assets/img/200x327/img4.jpg"
                                        class="attachment-shop_catalog size-shop_catalog wp-post-image d-block mx-auto"
                                        alt="image-description"></a>
                            </div>
                            <div class="woocommerce-loop-product__body media-body ml-md-5d25">
                    ...
                    <div class="product product__card border-right">
                        <div class="media p-md-6 p-4 d-block d-md-flex">
                            <div class="woocommerce-loop-product__thumbnail mb-4 mb-md-0">
                                <a href="https://demo2.madrasthemes.com/bookworm-html/redesigned-octo-fiesta/html-demo/shop/single-product-v1.html"
                                    class="d-block"><img src="./views/assets/img/200x327/img5.jpg"
                                        class="attachment-shop_catalog size-shop_catalog wp-post-image d-block mx-auto"
                                        alt="image-description"></a>
                            </div>
                            <div class="woocommerce-loop-product__body media-body ml-md-5d25">
                    ...
                    <div class="product product__card border-right">
                        <div class="media p-md-6 p-4 d-block d-md-flex">
                            <div class="woocommerce-loop-product__thumbnail mb-4 mb-md-0">
                                <a href="https://demo2.madrasthemes.com/bookworm-html/redesigned-octo-fiesta/html-demo/shop/single-product-v1.html"
                                    class="d-block"><img src="./views/assets/img/200x327/img6.jpg"
                                        class="attachment-shop_catalog size-shop_catalog wp-post-image d-block mx-auto"
                                        alt="image-description"></a>
                            </div>
                            <div class="woocommerce-loop-product__body media-body ml-md-5d25">
            ...
            <header class="mb-5 d-md-flex justify-content-between align-items-center">
                ...
                <ul class="nav nav-gray-700 flex-nowrap flex-md-wrap overflow-auto overflow-md-visible" role="tablist">
                    <li class="nav-item mx-4 flex-shrink-0 flex-md-shrink-1">
                        <a class="nav-link pb-1 px-0 active" id="history-tab" data-toggle="tab" href="#history-1"
                            role="tab" aria-controls="history-1" aria-selected="true">History</a>
                    </li>
                    <li class="nav-item mx-4 flex-shrink-0 flex-md-shrink-1">
                        <a class="nav-link pb-1 px-0" id="sciencemath-tab" data-toggle="tab" href="#sciencemath-1"
                            role="tab" aria-controls="sciencemath-1" aria-selected="false">Science &amp; Math</a>
                    </li>
                    <li class="nav-item mx-4 flex-shrink-0 flex-md-shrink-1">
                            ...
                            <div
                                ...
                                <div class="banner__body">
                                    <div class="banner__image pb-1 mb-5">
                                        <img class="img-fluid" src="./views/assets/img/350x282/img1.png"
                                    ...
                                    <a href="https://demo2.madrasthemes.com/bookworm-html/redesigned-octo-fiesta/html-demo/shop/v1.html"
                                        class="btn btn-primary btn-wide rounded-0">View More</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-8">
                                        ...
                                        <div
                                            ...
                                            <div class="woocommerce-loop-product__body product__body pt-3 bg-white">
                                                ...
                                                <h2
                                                    class="woocommerce-loop-product__title product__title h6 text-lh-md mb-1 text-height-2 crop-text-2 h-dark">
                                                    <a
                                                        href="https://demo2.madrasthemes.com/bookworm-html/redesigned-octo-fiesta/html-demo/shop/single-product-v1.html">Man's
                                        ...
                                        <div
                                            ...
                                            <div class="woocommerce-loop-product__body product__body pt-3 bg-white">
                                                ...
                                                <h2
                                                    class="woocommerce-loop-product__title product__title h6 text-lh-md mb-1 text-height-2 crop-text-2 h-dark">
                                                    <a
                                                        href="https://demo2.madrasthemes.com/bookworm-html/redesigned-octo-fiesta/html-demo/shop/single-product-v1.html">Blindside
                                                        (Michael Bennett)</a>
                                                </h2>
                                                <div class="font-size-2  mb-1 text-truncate"><a
                                                        href="https://demo2.madrasthemes.com/bookworm-html/redesigned-octo-fiesta/html-demo/others/authors-single.html"
                                        ...
                                        <div
                                            ...
                                            <div class="woocommerce-loop-product__body product__body pt-3 bg-white">
                                                ...
                                                <h2
                                                    class="woocommerce-loop-product__title product__title h6 text-lh-md mb-1 text-height-2 crop-text-2 h-dark">
                                                    <a
                                                        href="https://demo2.madrasthemes.com/bookworm-html/redesigned-octo-fiesta/html-demo/shop/single-product-v1.html">Call
                                                        Me By Your Name</a>
                                                </h2>
                                                <div class="font-size-2  mb-1 text-truncate"><a
                                                        href="https://demo2.madrasthemes.com/bookworm-html/redesigned-octo-fiesta/html-demo/others/authors-single.html"
                                        ...
                                        <div
                                            ...
                                            <div class="woocommerce-loop-product__body product__body pt-3 bg-white">
                                                ...
                                                <h2
                                                    class="woocommerce-loop-product__title product__title h6 text-lh-md mb-1 text-height-2 crop-text-2 h-dark">
                                                    <a
                                                        href="https://demo2.madrasthemes.com/bookworm-html/redesigned-octo-fiesta/html-demo/shop/single-product-v1.html">Camino
                                                        Winds</a>
                                                </h2>
                                                <div class="font-size-2  mb-1 text-truncate"><a
                                                        href="https://demo2.madrasthemes.com/bookworm-html/redesigned-octo-fiesta/html-demo/others/authors-single.html"
            ...
            <div class="js-slick-carousel u-slick products border"
                ...
                <div class="product product__card border-right">
                    <div class="media p-3 p-md-4d875">
                        <a href="https://demo2.madrasthemes.com/bookworm-html/redesigned-octo-fiesta/html-demo/shop/single-product-v1.html"
                            class="d-block"><img src="./views/assets/img/120x180/img1.jpg" alt="image-description"></a>
                        <div class="media-body ml-4d875">
                            <div class="text-uppercase font-size-1 mb-1 text-truncate"><a
                                    href="https://demo2.madrasthemes.com/bookworm-html/redesigned-octo-fiesta/html-demo/shop/single-product-v1.html">Hard
                                    Cover</a></div>
                            <h2
                ...
                <div class="product product__card border-right">
                    <div class="media p-3 p-md-4d875">
                        <a href="https://demo2.madrasthemes.com/bookworm-html/redesigned-octo-fiesta/html-demo/shop/single-product-v1.html"
                            class="d-block"><img src="./views/assets/img/120x180/img2.jpg" alt="image-description"></a>
                        <div class="media-body ml-4d875">
                            <div class="text-uppercase font-size-1 mb-1 text-truncate"><a
                                    href="https://demo2.madrasthemes.com/bookworm-html/redesigned-octo-fiesta/html-demo/shop/single-product-v1.html">Hard
                                    Cover</a></div>
                ...
                <div class="product product__card border-right">
                    <div class="media p-3 p-md-4d875">
                        <a href="https://demo2.madrasthemes.com/bookworm-html/redesigned-octo-fiesta/html-demo/shop/single-product-v1.html"
                            class="d-block"><img src="./views/assets/img/120x180/img3.jpg" alt="image-description"></a>
                        <div class="media-body ml-4d875">
                            <div class="text-uppercase font-size-1 mb-1 text-truncate"><a
                                    href="https://demo2.madrasthemes.com/bookworm-html/redesigned-octo-fiesta/html-demo/shop/single-product-v1.html">Hard
                                    Cover</a></div>
                            <h2
                                class="woocommerce-loop-product__title h6 text-lh-md mb-1 text-height-2 crop-text-2 h-dark">
                                <a
                                    href="https://demo2.madrasthemes.com/bookworm-html/redesigned-octo-fiesta/html-demo/shop/single-product-v1.html">Russians
                ...
                <div class="product product__card border-right">
                    <div class="media p-3 p-md-4d875">
                        <a href="https://demo2.madrasthemes.com/bookworm-html/redesigned-octo-fiesta/html-demo/shop/single-product-v1.html"
                            class="d-block"><img src="./views/assets/img/120x180/img4.jpg" alt="image-description"></a>
                        <div class="media-body ml-4d875">
                            <div class="text-uppercase font-size-1 mb-1 text-truncate"><a
                                    href="https://demo2.madrasthemes.com/bookworm-html/redesigned-octo-fiesta/html-demo/shop/single-product-v1.html">Hard
                                    Cover</a></div>
                ...
                <div class="product product__card border-right">
                    <div class="media p-3 p-md-4d875">
                        <a href="https://demo2.madrasthemes.com/bookworm-html/redesigned-octo-fiesta/html-demo/shop/single-product-v1.html"
                            class="d-block"><img src="./views/assets/img/120x180/img5.jpg" alt="image-description"></a>
                        <div class="media-body ml-4d875">
                            <div class="text-uppercase font-size-1 mb-1 text-truncate"><a
                                    href="https://demo2.madrasthemes.com/bookworm-html/redesigned-octo-fiesta/html-demo/shop/single-product-v1.html">Hard
                                    Cover</a></div>
                ...
                <div class="product product__card border-right">
                    <div class="media p-3 p-md-4d875">
                        <a href="https://demo2.madrasthemes.com/bookworm-html/redesigned-octo-fiesta/html-demo/shop/single-product-v1.html"
                            class="d-block"><img src="./views/assets/img/120x180/img6.jpg" alt="image-description"></a>
                        <div class="media-body ml-4d875">
                            <div class="text-uppercase font-size-1 mb-1 text-truncate"><a
                                    href="https://demo2.madrasthemes.com/bookworm-html/redesigned-octo-fiesta/html-demo/shop/single-product-v1.html">Hard
                                    Cover</a></div>
                ...
                <div class="product product__card border-right">
                    <div class="media p-3 p-md-4d875">
                        <a href="https://demo2.madrasthemes.com/bookworm-html/redesigned-octo-fiesta/html-demo/shop/single-product-v1.html"
                            class="d-block"><img src="./views/assets/img/120x180/img7.jpg" alt="image-description"></a>
                        <div class="media-body ml-4d875">
                            <div class="text-uppercase font-size-1 mb-1 text-truncate"><a
                                    href="https://demo2.madrasthemes.com/bookworm-html/redesigned-octo-fiesta/html-demo/shop/single-product-v1.html">Hard
                                    Cover</a></div>
            ...
            <ul class="row rows-cols-5 no-gutters authors list-unstyled js-slick-carousel u-slick" data-slides-show="5"
                ...
                <li class="author col">
                    <a href="https://demo2.madrasthemes.com/bookworm-html/redesigned-octo-fiesta/html-demo/others/authors-single.html"
                        class="text-reset">
                        <img src="./views/assets/img/140x140/img1.jpg" class="mx-auto mb-5 d-block rounded-circle"
                            alt="image-description">
                ...
                <li class="author col">
                    <a href="https://demo2.madrasthemes.com/bookworm-html/redesigned-octo-fiesta/html-demo/others/authors-single.html"
                        class="text-reset">
                        <img src="./views/assets/img/140x140/img2.jpg" class="mx-auto mb-5 d-block rounded-circle"
                            alt="image-description">
                        <div class="author__body text-center">
                ...
                <li class="author col">
                    <a href="https://demo2.madrasthemes.com/bookworm-html/redesigned-octo-fiesta/html-demo/others/authors-single.html"
                        class="text-reset">
                        <img src="./views/assets/img/140x140/img3.jpg" class="mx-auto mb-5 d-block rounded-circle"
                            alt="image-description">
                        <div class="author__body text-center">
                ...
                <li class="author col">
                    <a href="https://demo2.madrasthemes.com/bookworm-html/redesigned-octo-fiesta/html-demo/others/authors-single.html"
                        class="text-reset">
                        <img src="./views/assets/img/140x140/img4.jpg" class="mx-auto mb-5 d-block rounded-circle"
                            alt="image-description">
                        <div class="author__body text-center">
                ...
                <li class="author col">
                    <a href="https://demo2.madrasthemes.com/bookworm-html/redesigned-octo-fiesta/html-demo/others/authors-single.html"
                        class="text-reset">
                        <img src="./views/assets/img/140x140/img5.jpg" class="mx-auto mb-5 d-block rounded-circle"
                            alt="image-description">
                        <div class="author__body text-center">
                ...
                <li class="author col">
                    <a href="https://demo2.madrasthemes.com/bookworm-html/redesigned-octo-fiesta/html-demo/others/authors-single.html"
                        class="text-reset">
                        <img src="./views/assets/img/140x140/img6.jpg" class="mx-auto mb-5 d-block rounded-circle"
                            alt="image-description">
                        <div class="author__body text-center">
                            <h2 class="author__name h6 mb-0">David Walliams</h2>
                            <div class="text-gray-700 font-size-2">25 Published Books</div>
                ...
                <li class="author col">
                    <a href="https://demo2.madrasthemes.com/bookworm-html/redesigned-octo-fiesta/html-demo/others/authors-single.html"
                        class="text-reset">
                        <img src="./views/assets/img/140x140/img7.jpg" class="mx-auto mb-5 d-block rounded-circle"
                            alt="image-description">
                        <div class="author__body text-center">
                            <h2 class="author__name h6 mb-0">Joe Wicks</h2>
                            <div class="text-gray-700 font-size-2">25 Published Books</div>
                ...
                <li class="author col">
                    <a href="https://demo2.madrasthemes.com/bookworm-html/redesigned-octo-fiesta/html-demo/others/authors-single.html"
                        class="text-reset">
                        <img src="./views/assets/img/140x140/img8.jpg" class="mx-auto mb-5 d-block rounded-circle"
                            alt="image-description">
                        <div class="author__body text-center">
                            <h2 class="author__name h6 mb-0">Barbara O'Neil</h2>
                            <div class="text-gray-700 font-size-2">25 Published Books</div>
