                                            ...
                                            <tr class="woocommerce-cart-form__cart-item cart_item">
                                                <td class="product-name" data-title="Product">
                                                    <div class="d-flex align-items-center">
                                                        <a href="#">
                                                            <img src="views/assets/img/90x138/img1.jpg"
            ...
            <div id="secondary" class="sidebar cart-collaterals order-1" role="complementary">
                    ...
                    <div class="p-4d875 border">
                        <div id="cartHeadingTwo" class="cart-head">
                            <a class="d-flex align-items-center justify-content-between text-dark" href="#"
                                ...
                                <h3 class="cart-title mb-0 font-weight-medium font-size-3">Đang chuyển hàng</h3>
                                <svg class="mins" xmlns="http://www.w3.org/2000/svg"
                                    xmlns:xlink="http://www.w3.org/1999/xlink" width="15px" height="2px">
                                    <path fill-rule="evenodd" fill="rgb(22, 22, 25)"
                                        d="M0.000,-0.000 L15.000,-0.000 L15.000,2.000 L0.000,2.000 L0.000,-0.000 Z">
                            ...
                            <ul id="shipping_method">
                                <li>
                                    <input type="radio" name="shipping_method[0]" data-index="0"
                                        id="shipping_method_0_flat_rate1" value="flat_rate:1" class="shipping_method">
                                ...
                                <li>
                                    <input type="radio" name="shipping_method[0]" data-index="0"
                                        ...
                                        checked="checked">
                                    <label for="shipping_method_0_flat_rate2">Giá cố định: <span
                                            class="woocommerce-Price-amount amount"><span
                                                class="woocommerce-Price-currencySymbol">15.000</span> VNĐ</span></label>
                                </li>
                                <li>
                                    <input type="radio" name="shipping_method[0]" data-index="0"
                                        id="shipping_method_0_flat_rate3" value="flat_rate:2" class="shipping_method"
                                        checked="checked">
                                    <label for="shipping_method_0_flat_rate3">Nhận hàng tận nơi: <span
                                            class="woocommerce-Price-amount amount"><span
                                                class="woocommerce-Price-currencySymbol">50.000</span>VNĐ</span></label>
                                </li>
                            </ul>

                            <span class="font-size-2">Mã giảm giá:</span><a href="#"
                                class="font-weight-medium h-primary ml-3 font-size-2">Thay đổi địa chỉ</a>
                        </div>
                    </div>
                    <div class="p-4d875 border">
                ...
                <div class="wc-proceed-to-checkout">
                    <a href="index.php?act=thanhtoan"
                        class="checkout-button button alt wc-forward btn btn-dark btn-block rounded-0 py-4">Thanh toán</a>
                </div>
            </div>
        </div>
    </div>
