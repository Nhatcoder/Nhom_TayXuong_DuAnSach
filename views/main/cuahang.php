<div class="page-header border-bottom mb-8" bis_skin_checked="1">
    <div class="container" bis_skin_checked="1">
        <div class="d-md-flex justify-content-between align-items-center py-4" bis_skin_checked="1">
...
<div class="site-content space-bottom-3" id="content" bis_skin_checked="1">
    <div class="container" bis_skin_checked="1">
        <div class="row" bis_skin_checked="1">
            <div id="primary" class="content-area order-2" bis_skin_checked="1">
                <div class="shop-control-bar d-lg-flex justify-content-between align-items-center mb-5 text-center text-md-left" bis_skin_checked="1">
                    <div class="shop-control-bar__left mb-4 m-lg-0" bis_skin_checked="1">
                        <p class="woocommerce-result-count m-0">Showing 1–12 of 126 results</p>
                    </div>
                    <div class="shop-control-bar__right d-md-flex align-items-center" bis_skin_checked="1">
                        <form class="woocommerce-ordering mb-4 m-md-0" method="get">

                            <div class="dropdown bootstrap-select js-select dropdown-select orderby" bis_skin_checked="1"><select class="js-select selectpicker dropdown-select orderby" name="orderby" data-style="border-bottom shadow-none outline-none py-2" tabindex="-98">
                                    <option value="popularity">Sort by popularity</option>
                                    <option value="default" selected="selected">Default sorting</option>
                                    <option value="date">Sort by newness</option>
                                    <option value="price">Sort by price: low to high</option>
                                    <option value="price-desc">Sort by price: high to low</option>
                                </select><button type="button" class="btn dropdown-toggle border-bottom shadow-none outline-none py-2" data-toggle="dropdown" role="button" title="Default sorting">
                                    <div class="filter-option" bis_skin_checked="1">
                                        <div class="filter-option-inner" bis_skin_checked="1">
                                            <div class="filter-option-inner-inner" bis_skin_checked="1">Default sorting</div>
                                        </div>
                                    </div>
                                </button>
                                <div class="dropdown-menu " role="combobox" bis_skin_checked="1">
                                    <div class="inner show" role="listbox" aria-expanded="false" tabindex="-1" bis_skin_checked="1">
                        ...
                        <form class="number-of-items ml-md-4 mb-4 m-md-0 d-none d-xl-block" method="get">
                            ...
                            <div class="dropdown bootstrap-select js-select dropdown-select orderby fit-width" bis_skin_checked="1"><select class="js-select selectpicker dropdown-select orderby" name="orderby" data-style="border-bottom shadow-none outline-none py-2" data-width="fit" tabindex="-98">
                                ...
                                </select><button type="button" class="btn dropdown-toggle border-bottom shadow-none outline-none py-2" data-toggle="dropdown" role="button" title="Show 20">
                                    <div class="filter-option" bis_skin_checked="1">
                                        <div class="filter-option-inner" bis_skin_checked="1">
                                            <div class="filter-option-inner-inner" bis_skin_checked="1">Show 20</div>
                                        </div>
                                    </div>
                                </button>
                                <div class="dropdown-menu " role="combobox" bis_skin_checked="1">
                ...
                <div class="tab-content" id="pills-tabContent" bis_skin_checked="1">
                    <div class="tab-pane fade show active" id="pills-one-example1" role="tabpanel" aria-labelledby="pills-one-example1-tab" bis_skin_checked="1">

                        <ul class="products list-unstyled row no-gutters row-cols-2 row-cols-lg-3 row-cols-wd-4 border-top border-left mb-6">
                            <li class="product col">
                                <div class="product__inner overflow-hidden p-3 p-md-4d875" bis_skin_checked="1">
                                    <div class="woocommerce-LoopProduct-link woocommerce-loop-product__link d-block position-relative" bis_skin_checked="1">
                                        <div class="woocommerce-loop-product__thumbnail" bis_skin_checked="1">
                                        ...
                                        <div class="woocommerce-loop-product__body product__body pt-3 bg-white" bis_skin_checked="1">
                                            <div class="text-uppercase font-size-1 mb-1 text-truncate" bis_skin_checked="1"><a href="../shop/single-product-v1.html">Paperback</a></div>
                                            ...
                                            <div class="font-size-2  mb-1 text-truncate" bis_skin_checked="1"><a href="../others/authors-single.html" class="text-gray-700">Jay Shetty</a></div>
                                            <div class="price d-flex align-items-center font-weight-medium font-size-3" bis_skin_checked="1">
                                                <span class="woocommerce-Price-amount amount"><span class="woocommerce-Price-currencySymbol">$</span>29</span>
                                            </div>
                                        </div>
                                        <div class="product__hover d-flex align-items-center" bis_skin_checked="1">
                            ...
                            <li class="product col">
                                <div class="product__inner overflow-hidden p-3 p-md-4d875" bis_skin_checked="1">
                                    <div class="woocommerce-LoopProduct-link woocommerce-loop-product__link d-block position-relative" bis_skin_checked="1">
                                        <div class="woocommerce-loop-product__thumbnail" bis_skin_checked="1">
                                            <a href="../shop/single-product-v1.html" class="d-block"><img src="../../assets/img/150x226/img8.jpg" class="img-fluid d-block mx-auto attachment-shop_catalog size-shop_catalog wp-post-image img-fluid" alt="image-description"></a>
                                        </div>
                                        <div class="woocommerce-loop-product__body product__body pt-3 bg-white" bis_skin_checked="1">
                                            <div class="text-uppercase font-size-1 mb-1 text-truncate" bis_skin_checked="1"><a href="../shop/single-product-v1.html">Paperback</a></div>
                                            <h2 class="woocommerce-loop-product__title product__title h6 text-lh-md mb-1 text-height-2 crop-text-2 h-dark"><a href="../shop/single-product-v1.html">All You Can Ever Know: A Memoir</a></h2>
                            ...
                            <li class="product col">
                                <div class="product__inner overflow-hidden p-3 p-md-4d875" bis_skin_checked="1">
                                    <div class="woocommerce-LoopProduct-link woocommerce-loop-product__link d-block position-relative" bis_skin_checked="1">
                                        <div class="woocommerce-loop-product__thumbnail" bis_skin_checked="1">
                                            <a href="../shop/single-product-v1.html" class="d-block"><img src="../../assets/img/150x226/img9.jpg" class="img-fluid d-block mx-auto attachment-shop_catalog size-shop_catalog wp-post-image img-fluid" alt="image-description"></a>
                                        </div>
                                        <div class="woocommerce-loop-product__body product__body pt-3 bg-white" bis_skin_checked="1">
                                            <div class="text-uppercase font-size-1 mb-1 text-truncate" bis_skin_checked="1"><a href="../shop/single-product-v1.html">Paperback</a></div>
                                            <h2 class="woocommerce-loop-product__title product__title h6 text-lh-md mb-1 text-height-2 crop-text-2 h-dark"><a href="../shop/single-product-v1.html">Think Like a Monk: Train Your Mind for Peace and Purpose Everyday</a></h2>
                            ...
                            <li class="product col">
                                <div class="product__inner overflow-hidden p-3 p-md-4d875" bis_skin_checked="1">
                                    <div class="woocommerce-LoopProduct-link woocommerce-loop-product__link d-block position-relative" bis_skin_checked="1">
                                        <div class="woocommerce-loop-product__thumbnail" bis_skin_checked="1">
                                            <a href="../shop/single-product-v1.html" class="d-block"><img src="../../assets/img/150x226/img10.jpg" class="img-fluid d-block mx-auto attachment-shop_catalog size-shop_catalog wp-post-image img-fluid" alt="image-description"></a>
                                        </div>
                                        <div class="woocommerce-loop-product__body product__body pt-3 bg-white" bis_skin_checked="1">
                                            <div class="text-uppercase font-size-1 mb-1 text-truncate" bis_skin_checked="1"><a href="../shop/single-product-v1.html">Paperback</a></div>
                                            <h2 class="woocommerce-loop-product__title product__title h6 text-lh-md mb-1 text-height-2 crop-text-2 h-dark"><a href="../shop/single-product-v1.html">The Overdue Life of Amy Byler</a></h2>
                    ...
                    <div class="tab-pane fade" id="pills-two-example1" role="tabpanel" aria-labelledby="pills-two-example1-tab" bis_skin_checked="1">

                        <ul class="products list-unstyled mb-6">
                            <li class="product product__list">
                                <div class="product__inner overflow-hidden p-3 p-md-4d875" bis_skin_checked="1">
                                    <div class="woocommerce-LoopProduct-link woocommerce-loop-product__link row position-relative" bis_skin_checked="1">
                                        <div class="col-md-auto woocommerce-loop-product__thumbnail mb-3 mb-md-0" bis_skin_checked="1">
                                            <a href="../shop/single-product-v1.html" class="d-block"><img src="../../assets/img/150x226/img1.jpg" class="img-fluid d-block mx-auto attachment-shop_catalog size-shop_catalog wp-post-image img-fluid" alt="image-description"></a>
                                        </div>
                                        <div class="col-md woocommerce-loop-product__body product__body pt-3 bg-white mb-3 mb-md-0" bis_skin_checked="1">
                                            <div class="text-uppercase font-size-1 mb-1 text-truncate" bis_skin_checked="1"><a href="../shop/single-product-v1.html">Paperback</a></div>
                                            <h2 class="woocommerce-loop-product__title product__title h6 text-lh-md mb-1 crop-text-2 h-dark"><a href="../shop/single-product-v1.html" tabindex="0">The Overdue Life of Amy Byler</a></h2>
                                            <div class="font-size-2  mb-2 text-truncate" bis_skin_checked="1"><a href="../others/authors-single.html" class="text-gray-700">Jay Shetty</a></div>
                                        ...
                                        <div class="col-md-auto d-flex align-items-center" bis_skin_checked="1">
                                            <a href="../shop/single-product-v1.html" class="text-uppercase text-dark h-dark font-weight-medium mr-4" data-toggle="tooltip" data-placement="right" title="" data-original-title="ADD TO CART">
                                                <span class="product__add-to-cart">ADD TO CART</span>
                                                <span class="product__add-to-cart-icon font-size-4"><i class="flaticon-icon-126515"></i></span>
                                            </a>
                                            <a href="../shop/single-product-v1.html" class="mr-1 h-p-bg btn btn-outline-primary border-0">
                            ...
                            <li class="product product__list">
                                <div class="product__inner overflow-hidden p-3 p-md-4d875" bis_skin_checked="1">
                                    <div class="woocommerce-LoopProduct-link woocommerce-loop-product__link row position-relative" bis_skin_checked="1">
                                        ...
                                        <div class="col-md woocommerce-loop-product__body product__body pt-3 bg-white mb-3 mb-md-0" bis_skin_checked="1">
                                            <div class="text-uppercase font-size-1 mb-1 text-truncate" bis_skin_checked="1"><a href="../shop/single-product-v1.html">Paperback</a></div>
                                            <h2 class="woocommerce-loop-product__title product__title h6 text-lh-md mb-1 crop-text-2 h-dark"><a href="../shop/single-product-v1.html" tabindex="0">All You Can Ever Know: A Memoir</a></h2>
                                            <div class="font-size-2  mb-2 text-truncate" bis_skin_checked="1"><a href="../others/authors-single.html" class="text-gray-700">Jay Shetty</a></div>
                                            <p class="font-size-2 mb-2 crop-text-2">After disappearing for three years, Artemis Fowl has returned to a life different from the one he left. And spends his days teaching his twin siblings the</p>
                                            <div class="price d-flex align-items-center font-weight-medium font-size-3" bis_skin_checked="1">
                                                <span class="woocommerce-Price-amount amount"><span class="woocommerce-Price-currencySymbol">$</span>29</span>
                            ...
                            <li class="product product__list">
                                <div class="product__inner overflow-hidden p-3 p-md-4d875" bis_skin_checked="1">
                                    <div class="woocommerce-LoopProduct-link woocommerce-loop-product__link row position-relative" bis_skin_checked="1">
                                        ...
                                        <div class="col-md woocommerce-loop-product__body product__body pt-3 bg-white mb-3 mb-md-0" bis_skin_checked="1">
                                            <div class="text-uppercase font-size-1 mb-1 text-truncate" bis_skin_checked="1"><a href="../shop/single-product-v1.html">Paperback</a></div>
                                            <h2 class="woocommerce-loop-product__title product__title h6 text-lh-md mb-1 crop-text-2 h-dark"><a href="../shop/single-product-v1.html" tabindex="0">The Cinderella Reversal</a></h2>
                                            <div class="font-size-2  mb-2 text-truncate" bis_skin_checked="1"><a href="../others/authors-single.html" class="text-gray-700">Jay Shetty</a></div>
                                            <p class="font-size-2 mb-2 crop-text-2">After disappearing for three years, Artemis Fowl has returned to a life different from the one he left. And spends his days teaching his twin siblings the</p>
                                            <div class="price d-flex align-items-center font-weight-medium font-size-3" bis_skin_checked="1">
                                                <span class="woocommerce-Price-amount amount"><span class="woocommerce-Price-currencySymbol">$</span>29</span>
                            ...
                            <li class="product product__list">
                                <div class="product__inner overflow-hidden p-3 p-md-4d875" bis_skin_checked="1">
                                    <div class="woocommerce-LoopProduct-link woocommerce-loop-product__link row position-relative" bis_skin_checked="1">
                                        ...
                                        <div class="col-md woocommerce-loop-product__body product__body pt-3 bg-white mb-3 mb-md-0" bis_skin_checked="1">
                                            <div class="text-uppercase font-size-1 mb-1 text-truncate" bis_skin_checked="1"><a href="../shop/single-product-v1.html">Paperback</a></div>
                                            <h2 class="woocommerce-loop-product__title product__title h6 text-lh-md mb-1 crop-text-2 h-dark"><a href="../shop/single-product-v1.html" tabindex="0">Scot Under the Covers: The Wild Wicked</a></h2>
                                            <div class="font-size-2  mb-2 text-truncate" bis_skin_checked="1"><a href="../others/authors-single.html" class="text-gray-700">Jay Shetty</a></div>
                                            <p class="font-size-2 mb-2 crop-text-2">After disappearing for three years, Artemis Fowl has returned to a life different from the one he left. And spends his days teaching his twin siblings the</p>
                                            <div class="price d-flex align-items-center font-weight-medium font-size-3" bis_skin_checked="1">
                                                <span class="woocommerce-Price-amount amount"><span class="woocommerce-Price-currencySymbol">$</span>29</span>
                            ...
                            <li class="product product__list">
                                <div class="product__inner overflow-hidden p-3 p-md-4d875" bis_skin_checked="1">
                                    <div class="woocommerce-LoopProduct-link woocommerce-loop-product__link row position-relative" bis_skin_checked="1">
                                        ...
                                        <div class="col-md woocommerce-loop-product__body product__body pt-3 bg-white mb-3 mb-md-0" bis_skin_checked="1">
                                            <div class="text-uppercase font-size-1 mb-1 text-truncate" bis_skin_checked="1"><a href="../shop/single-product-v1.html">Paperback</a></div>
                                            <h2 class="woocommerce-loop-product__title product__title h6 text-lh-md mb-1 crop-text-2 h-dark"><a href="../shop/single-product-v1.html" tabindex="0">Winter Garden</a></h2>
                                            <div class="font-size-2  mb-2 text-truncate" bis_skin_checked="1"><a href="../others/authors-single.html" class="text-gray-700">Jay Shetty</a></div>
                                            <p class="font-size-2 mb-2 crop-text-2">After disappearing for three years, Artemis Fowl has returned to a life different from the one he left. And spends his days teaching his twin siblings the</p>
                                            <div class="price d-flex align-items-center font-weight-medium font-size-3" bis_skin_checked="1">
                                                <span class="woocommerce-Price-amount amount"><span class="woocommerce-Price-currencySymbol">$</span>29</span>
                            ...
                            <li class="product product__list">
                                <div class="product__inner overflow-hidden p-3 p-md-4d875" bis_skin_checked="1">
                                    <div class="woocommerce-LoopProduct-link woocommerce-loop-product__link row position-relative" bis_skin_checked="1">
                                        ...
                                        <div class="col-md woocommerce-loop-product__body product__body pt-3 bg-white mb-3 mb-md-0" bis_skin_checked="1">
                                            <div class="text-uppercase font-size-1 mb-1 text-truncate" bis_skin_checked="1"><a href="../shop/single-product-v1.html">Paperback</a></div>
                                            <h2 class="woocommerce-loop-product__title product__title h6 text-lh-md mb-1 crop-text-2 h-dark"><a href="../shop/single-product-v1.html" tabindex="0">Call Me By Your Name</a></h2>
                                            <div class="font-size-2  mb-2 text-truncate" bis_skin_checked="1"><a href="../others/authors-single.html" class="text-gray-700">Jay Shetty</a></div>
                                            <p class="font-size-2 mb-2 crop-text-2">After disappearing for three years, Artemis Fowl has returned to a life different from the one he left. And spends his days teaching his twin siblings the</p>
                                            <div class="price d-flex align-items-center font-weight-medium font-size-3" bis_skin_checked="1">
                                                <span class="woocommerce-Price-amount amount"><span class="woocommerce-Price-currencySymbol">$</span>29</span>
            ...
            <div id="secondary" class="sidebar widget-area order-1" role="complementary" bis_skin_checked="1">
                <div id="widgetAccordion" bis_skin_checked="1">
                    <div id="woocommerce_product_categories-2" class="widget p-4d875 border woocommerce widget_product_categories" bis_skin_checked="1">
                        <div id="widgetHeadingOne" class="widget-head" bis_skin_checked="1">
                        ...
                        <div id="widgetCollapseOne" class="mt-3 widget-content collapse show" aria-labelledby="widgetHeadingOne" data-parent="#widgetAccordion" bis_skin_checked="1">
                    ...
                    <div id="Authors" class="widget widget_search widget_author p-4d875 border" bis_skin_checked="1">
                        <div id="widgetHeading21" class="widget-head" bis_skin_checked="1">
                        ...
                        <div id="widgetCollapse21" class="mt-4 widget-content collapse show" aria-labelledby="widgetHeading21" data-parent="#widgetAccordion" bis_skin_checked="1">
                            <form class="form-inline my-2 overflow-hidden">
                                <div class="input-group flex-nowrap w-100" bis_skin_checked="1">
                    ...
                    <div id="Language" class="widget p-4d875 border" bis_skin_checked="1">
                        <div id="widgetHeading22" class="widget-head" bis_skin_checked="1">
                        ...
                        <div id="widgetCollapse22" class="mt-4 widget-content collapse show" aria-labelledby="widgetHeading22" data-parent="#widgetAccordion" bis_skin_checked="1">
                            <ul class="product-categories">
                    ...
                    <div id="Format" class="widget p-4d875 border" bis_skin_checked="1">
                        <div id="widgetHeading23" class="widget-head" bis_skin_checked="1">
                        ...
                        <div id="widgetCollapse23" class="mt-3 widget-content collapse show" aria-labelledby="widgetHeading23" data-parent="#widgetAccordion" bis_skin_checked="1">
                            <ul class="product-categories">
                                <li class="cat-item cat-item-9 cat-parent">
                    ...
                    <div id="woocommerce_price_filter-2" class="widget p-4d875 border woocommerce widget_price_filter" bis_skin_checked="1">
                        <div id="widgetHeadingTwo" class="widget-head" bis_skin_checked="1">
                        ...
                        <div id="widgetCollapseTwo" class="mt-4 widget-content collapse show" aria-labelledby="widgetHeadingTwo" data-parent="#widgetAccordion" bis_skin_checked="1">
                            <form method="get" action="https://themes.woocommerce.com/storefront/shop/">
                                <div class="price_slider_wrapper" bis_skin_checked="1">
                                    <div class="price_slider ui-slider ui-slider-horizontal ui-widget ui-widget-content ui-corner-all" style="" bis_skin_checked="1">
                                        <div class="ui-slider-range ui-widget-header ui-corner-all" style="left: 0%; width: 100%;" bis_skin_checked="1"></div><span class="ui-slider-handle ui-state-default ui-corner-all" tabindex="0" style="left: 0%;"></span><span class="ui-slider-handle ui-state-default ui-corner-all" tabindex="0" style="left: 98%;"></span>
                                    </div>
                                    <div class="price_slider_amount" bis_skin_checked="1">
                                        ...
                                        <div class="mx-auto price_label mt-2" style="" bis_skin_checked="1">
                    ...
                    <div id="Review" class="widget p-4d875 border" bis_skin_checked="1">
                        <div id="widgetHeading24" class="widget-head" bis_skin_checked="1">
                        ...
                        <div id="widgetCollapse24" class="mt-4 widget-content collapse show" aria-labelledby="widgetHeading24" data-parent="#widgetAccordion" bis_skin_checked="1">
                            <div class="form-group d-flex align-items-center justify-content-between font-size-1 text-lh-md text-secondary mb-2 pb-1" bis_skin_checked="1">
                            ...
                            <div class="form-group d-flex align-items-center justify-content-between font-size-1 text-lh-md text-secondary mb-0" bis_skin_checked="1">
                                <div class="custom-control custom-checkbox" bis_skin_checked="1">
                    ...
                    <div id="Featuredbooks" class="widget p-4d875 border" bis_skin_checked="1">
                        <div id="widgetHeading25" class="widget-head" bis_skin_checked="1">
                        ...
                        <div id="widgetCollapse25" class="mt-5 widget-content collapse show" aria-labelledby="widgetHeading25" data-parent="#widgetAccordion" bis_skin_checked="1">
                            <div class="mb-5" bis_skin_checked="1">
                                <div class="media d-md-flex" bis_skin_checked="1">
                                    <a class="d-block" href="../shop/single-product-v3.html">
                                        <img class="img-fluid" src="../../assets/img/60x92/img1.jpg" alt="Image-Description">
                                    </a>
                                    <div class="media-body ml-3 pl-1" bis_skin_checked="1">
