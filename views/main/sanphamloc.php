<div class="page-header border-bottom mb-8">
    <div class="container">
        <div class="d-md-flex justify-content-between align-items-center py-4">
            <h1 class="page-title font-size-3 font-weight-medium m-0 text-lh-lg">SẢN PHẨM CỦA SHOP</h1>
            <nav class="woocommerce-breadcrumb font-size-2">
                <a href="../home/index.html" class="h-primary">Trang chủ</a>
                <span class="breadcrumb-separator mx-1"><i class="fas fa-angle-right"></i></span>
                <a href="../shop/v3.html" class="h-primary">Sản phẩm</a>
            </nav>
        </div>
    </div>
</div>
            ...
            <div id="secondary" class="sidebar widget-area order-1" role="complementary">
                ...
                <div class="search_price">
                    <form action="index.php?act=sanphamloc" method="post">
                        <h5>Lọc giá</h5>
                        <div class="d-flex">
                            <input type="number" name="gia_start" min="0" value="<?= isset($_POST['gia_start']) ? $_POST['gia_start'] : '' ?>" class="form-control" placeholder="Từ">
                            <input type="number" name="gia_end" min="0" value="<?= isset($_POST['gia_end']) ? $_POST['gia_end'] : '' ?> " class="form-control" placeholder="Đến">
                        </div>
                        <button name="loc_gia" type="locgia" class="btn btn-primary" style="margin-top: 20px;">Áp dụng</button>
                    </form>
                </div>
            </div>
        </div>
