            ...
            <div class="site-navigation mr-auto d-none d-xl-block">
                <ul class="nav">
                    <li class="nav-item dropdown">
                        <a id="homeDropdownInvoker" href="index.php"
                            class="dropdown-toggle nav-link link-black-100 mx-4 px-0 py-5 font-weight-medium d-flex align-items-center active"
                        ...
                        <ul id="shopDropdownMenu"
                            ...
                            <li class="position-relative">
                                <a id="shopDropdownsubmenuoneInvoker" href="#"
                                    ...
                                    data-unfold-animation-in="slideInUp" data-unfold-animation-out="fadeOut">Shop
                                    List
                                </a>
                            ...
                            <li class="position-relative">
                                <a id="shopDropdownsubmenutwoInvoker" href="#"
                                    ...
                                    data-unfold-duration="200" data-unfold-delay="100" data-unfold-hide-on-scroll="true"
                                    data-unfold-animation-in="slideInUp" data-unfold-animation-out="fadeOut">Single
                                    Product
                                </a>
                                    ...
                                    <div class="banner px-8 py-5">
                                        <div class="banner__body">
                                            ...
                                            <div class="banner__image">
                                                <img src="./views/assets/img/280x213/img1.png" class="img-fluid"
            ...
            <ul class="d-md-none nav mr-md-n3 ml-auto">
                <li class="nav-item">
                    ...
                    <a id="sidebarNavToggler9" href="javascript:;" role="button" class="px-2 nav-link link-black-100"
                        ...
                        data-unfold-target="#sidebarContent9" data-unfold-type="css-animation" data-unfold-overlay="{
                                    &quot;className&quot;: &quot;u-sidebar-bg-overlay&quot;,
                                    &quot;background&quot;: &quot;rgba(0, 0, 0, .7)&quot;,
                                    &quot;animationSpeed&quot;: 500
