                                ...
                                <div class="topbar__nav d-md-flex justify-content-between align-items-center">
                                        ...
                                        <ul class="topbar__nav--right nav mr-md-n3">
                                                ...
                                                <li class="nav-item">
                                                        ...
                                                        <a id="sidebarNavToggler" href="index.php?act=dangnhap" role="button" class="nav-link link-black-100" aria-controls="sidebarContent" aria-haspopup="true" aria-expanded="false" data-unfold-event="click" data-unfold-hide-on-scroll="false" data-unfold-target="#sidebarContent" data-unfold-type="css-animation" data-unfold-overlay="{
