  ...
  <div class="content-header">
    <div class="container-fluid">
      ...
      <div class="card card-primary">
        ...
        <input type="hidden" name="sneaker_id" value="<?= $ma_sach ?>">  
        <div class="card-body">
            <div class="form-group">
              <label for="exampleInputEmail1">Tên sản phẩm</label>
              <input type="text" name="ten_sp" class="form-control" value="<?= $ten_sach ?>" placeholder="Nhập tên sản phẩm...">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              ...
              <div class="input-group">
                <div class="custom-file">
                  ...
                  <input type="hidden" name="oldhinh" value="<?= $hinh ?>" class="custom-file-input">
            ...
            <div style="margin: 20px 0;">
              ...
              <input type="text" name="nha_xb" class="form-control" value="<?= $nha_xuat_ban ?>" placeholder="Nhập nhà xuất bản...">
            </div>
            <div class="form-group">
              <label for="exampleInputEmail1">Ngày xuất bản</label>
              <input type="date" name="ngay_xb" class="form-control" value="<?= $ngay_xuat_ban ?>" placeholder="Nhập ngày xuất bản...">
            </div>  
            <div class="form-group">
            ...
            <div class="form-group">
              <select class="custom-select" name="ma_danh_muc" id="">
                ...
                foreach ($listDanhmuc as $dm) : ?>
                  <option value="<?= $dm['ma_danhmuc'] ?>" <?= $ma_danh_muc == $dm['ma_danhmuc']  ? 'selected' : '' ?> ><?= $dm['ten_danhmuc'] ?></option>
                <?php endforeach ?>
              </select>
            </div>
          </div>
